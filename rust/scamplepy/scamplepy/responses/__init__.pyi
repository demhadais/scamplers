...
class ChromiumDataset:
    ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
    def from_json_bytes(json_bytes:typing.Sequence[builtins.int]) -> ChromiumDataset: ...
    @staticmethod
    def from_json_string(json_str:builtins.str) -> ChromiumDataset: ...
    @staticmethod
    def from_base64_json(base64_json_bytes:builtins.str) -> ChromiumDataset: ...
...
class TenxAssay:
    ...
    def name(self) -> builtins.str: ...
    @property
    def library_types(self) -> typing.Optional[builtins.list[typing.Optional[builtins.str]]]: ...
    @property
    def sample_multiplexing(self) -> typing.Optional[builtins.str]: ...
    @property
