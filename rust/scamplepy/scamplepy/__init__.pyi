...
class ScamplersClient:
    async def list_person_specimens(
        self, id: uuid.UUID, query: SpecimenQuery = ...
    ) -> builtins.list[Specimen]: ...
    async def list_multiplexing_tags(self) -> builtins.list[MultiplexingTag]: ...
    async def list_chromium_runs(
        self, data: ChromiumRunQuery
    ) -> builtins.list[ChromiumRun]: ...
    ...
    async def list_suspension_pools(
        self, data: SuspensionPoolQuery
    ) -> builtins.list[SuspensionPool]: ...
    ...
    async def list_suspensions(
        self, data: SuspensionQuery
    ) -> builtins.list[Suspension]: ...
    async def fetch_suspension(self, data: uuid.UUID) -> Suspension: ...
    async def create_suspension(self, data: NewSuspension) -> Suspension: ...
    async def list_sequencing_runs(
        self, data: SequencingRunQuery
    ) -> builtins.list[SequencingRun]: ...
    ...
    async def list_institutions(
        self, data: InstitutionQuery
    ) -> builtins.list[Institution]: ...
    ...
    def __new__(
        cls,
        *,
        api_base_url: builtins.str,
        api_key: typing.Optional[builtins.str] = None,
        accept_invalid_certificates: builtins.bool = False,
    ) -> ScamplersClient: ...
