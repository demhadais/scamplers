...
class SuspensionMeasurementFields:
    ...
    class Concentration(SuspensionMeasurementFields):
        ...
        def __new__(cls, measured_at:datetime.datetime, instrument_name:typing.Optional[builtins.str], counting_method:CellCountingMethod, value:builtins.float, unit:tuple[BiologicalMaterial, VolumeUnit]) -> SuspensionMeasurementFields.Concentration: ...
