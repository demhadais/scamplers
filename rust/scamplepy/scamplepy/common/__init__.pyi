...
class ElectrophoreticMeasurementData:
    def __new__(cls, *, measured_at:datetime.datetime, instrument_name:builtins.str, mean_library_size_bp:builtins.float, sizing_range:tuple[builtins.int, builtins.int], concentration_value:builtins.float, concentration_unit:tuple[MassUnit, VolumeUnit]) -> ElectrophoreticMeasurementData: ...
