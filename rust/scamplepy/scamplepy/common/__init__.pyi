...
class NucleicAcidMeasurementData:
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
    def from_json_bytes(json_bytes:typing.Sequence[builtins.int]) -> NucleicAcidMeasurementData: ...
    @staticmethod
    def from_json_string(json_str:builtins.str) -> NucleicAcidMeasurementData: ...
    @staticmethod
    def from_base64_json(base64_json_bytes:builtins.str) -> NucleicAcidMeasurementData: ...
    class Electrophoretic(NucleicAcidMeasurementData):
        __match_args__ = ("measured_at", "instrument_name", "mean_size_bp", "sizing_range", "concentration",)
        @property
        def measured_at(self) -> datetime.datetime: ...
        @property
        def instrument_name(self) -> builtins.str: ...
        @property
        def mean_size_bp(self) -> typing.Optional[builtins.float]: ...
        @property
        def sizing_range(self) -> tuple[builtins.int, builtins.int]: ...
        @property
        def concentration(self) -> NucleicAcidConcentration: ...
        def __new__(cls, measured_at:datetime.datetime, instrument_name:builtins.str, mean_size_bp:typing.Optional[builtins.float], sizing_range:tuple[builtins.int, builtins.int], concentration:NucleicAcidConcentration) -> NucleicAcidMeasurementData.Electrophoretic: ...
    
    class Fluorometric(NucleicAcidMeasurementData):
        ...
        @property
        def concentration(self) -> NucleicAcidConcentration: ...
        def __new__(cls, measured_at:datetime.datetime, instrument_name:builtins.str, concentration:NucleicAcidConcentration) -> NucleicAcidMeasurementData.Fluorometric: ...
...
class SpecimenMeasurementData:
    ...
    class Rin(SpecimenMeasurementData):
        ...
        def measured_at(self) -> datetime.datetime: ...
        @property
        def instrument_name(self) -> typing.Optional[builtins.str]: ...
        @property
        def value(self) -> builtins.float: ...
        def __new__(cls, measured_at:datetime.datetime, instrument_name:typing.Optional[builtins.str], value:builtins.float) -> SpecimenMeasurementData.Rin: ...
    ...
    class Dv200(SpecimenMeasurementData):
        ...
        @property
        def value(self) -> builtins.float: ...
        def __new__(cls, measured_at:datetime.datetime, instrument_name:typing.Optional[builtins.str], value:builtins.float) -> SpecimenMeasurementData.Dv200: ...
    

class SuspensionMeasurementData:
    @fields.setter
    def fields(self, value: SuspensionMeasurementFields) -> None: ...
    @is_post_probe_hybridization.setter
    def is_post_probe_hybridization(self, value: builtins.bool) -> None: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class SuspensionMeasurementFields:
    ...
    class Concentration(SuspensionMeasurementFields):
        ...
        def instrument_name(self) -> typing.Optional[builtins.str]: ...
        @property
        def counting_method(self) -> typing.Optional[CellCountingMethod]: ...
        @property
        def value(self) -> builtins.float: ...
        @property
        def unit(self) -> tuple[BiologicalMaterial, VolumeUnit]: ...
        def __new__(cls, measured_at:datetime.datetime, instrument_name:typing.Optional[builtins.str], counting_method:typing.Optional[CellCountingMethod], value:builtins.float, unit:tuple[BiologicalMaterial, VolumeUnit]) -> SuspensionMeasurementFields.Concentration: ...
    ...
    class Viability(SuspensionMeasurementFields):
        ...
        @property
        def value(self) -> builtins.float: ...
        def __new__(cls, measured_at:datetime.datetime, instrument_name:typing.Optional[builtins.str], value:builtins.float) -> SuspensionMeasurementFields.Viability: ...
    ...
    class MeanDiameter(SuspensionMeasurementFields):
        ...
        def __new__(cls, measured_at:datetime.datetime, instrument_name:typing.Optional[builtins.str], value:builtins.float, unit:tuple[BiologicalMaterial, LengthUnit]) -> SuspensionMeasurementFields.MeanDiameter: ...
