...
class NewCellrangerCountDataset:
    ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, name:builtins.str, lab_id:uuid.UUID, data_path:builtins.str, delivered_at:datetime.datetime, library_ids:typing.Sequence[uuid.UUID], web_summaries:typing.Sequence[builtins.str], metrics:SingleRowCsvMetricsFile) -> NewCellrangerCountDataset: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class NewCellrangerMultiDataset:
    ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, name:builtins.str, lab_id:uuid.UUID, data_path:builtins.str, delivered_at:datetime.datetime, library_ids:typing.Sequence[uuid.UUID], web_summaries:typing.Sequence[builtins.str], metrics:typing.Sequence[MultiRowCsvMetricsFile]) -> NewCellrangerMultiDataset: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class NewCellrangerVdjDataset:
    ...
    def metrics(self, value: SingleRowCsvMetricsFile) -> None: ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, name:builtins.str, lab_id:uuid.UUID, data_path:builtins.str, delivered_at:datetime.datetime, library_ids:typing.Sequence[uuid.UUID], web_summaries:typing.Sequence[builtins.str], metrics:SingleRowCsvMetricsFile) -> NewCellrangerVdjDataset: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class NewCellrangerarcCountDataset:
    ...
    def metrics(self, value: SingleRowCsvMetricsFile) -> None: ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, name:builtins.str, lab_id:uuid.UUID, data_path:builtins.str, delivered_at:datetime.datetime, library_ids:typing.Sequence[uuid.UUID], web_summaries:typing.Sequence[builtins.str], metrics:SingleRowCsvMetricsFile) -> NewCellrangerarcCountDataset: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class NewCellrangeratacCountDataset:
    ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, name:builtins.str, lab_id:uuid.UUID, data_path:builtins.str, delivered_at:datetime.datetime, library_ids:typing.Sequence[uuid.UUID], web_summaries:typing.Sequence[builtins.str], metrics:JsonMetricsFile) -> NewCellrangeratacCountDataset: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class _NewChromiumDatasetCommon:
    ...
    @property
    def web_summaries(self) -> builtins.list[builtins.str]: ...
    @name.setter
    def name(self, value: builtins.str) -> None: ...
    @lab_id.setter
    ...
    @web_summaries.setter
    def web_summaries(self, value: builtins.list[builtins.str]) -> None: ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
