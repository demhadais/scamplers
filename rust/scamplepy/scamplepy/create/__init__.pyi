...
class NewOcmChipLoading:
    def __new__(cls, *, suspension_id:uuid.UUID, suspension_volume_loaded:SuspensionMeasurementFields, buffer_volume_loaded:SuspensionMeasurementFields, notes:typing.Optional[builtins.str]=None) -> NewOcmChipLoading: ...
...
class NewOcmGems:
    ...
    @property
    def loading(self) -> builtins.list[NewOcmChipLoading]: ...
    @inner.setter
    def inner(self, value: _NewGemsCommon) -> None: ...
    @loading.setter
    def loading(self, value: builtins.list[NewOcmChipLoading]) -> None: ...
    def __new__(cls, *, readable_id:builtins.str, chemistry:builtins.str, loading:typing.Sequence[NewOcmChipLoading]) -> NewOcmGems: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class NewSingleplexGems:
    ...
    def inner(self) -> _NewGemsCommon: ...
    @property
    def loading(self) -> _NewSingleplexChipLoading: ...
    @inner.setter
    def inner(self, value: _NewGemsCommon) -> None: ...
    @loading.setter
    def loading(self, value: _NewSingleplexChipLoading) -> None: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
