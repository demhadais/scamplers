...
class NewCryopreservedSuspension:
    ...
    def type_(self, value: SpecimenType) -> None: ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, readable_id:builtins.str, name:builtins.str, submitted_by:uuid.UUID, lab_id:uuid.UUID, received_at:datetime.datetime, species:typing.Sequence[Species], storage_buffer:typing.Optional[builtins.str]=None, measurements:typing.Sequence[NewSpecimenMeasurement]=[], committee_approvals:typing.Sequence[NewCommitteeApproval]=[], notes:typing.Optional[builtins.str]=None, returned_at:typing.Optional[datetime.datetime]=None, returned_by:typing.Optional[uuid.UUID]=None) -> NewCryopreservedSuspension: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class NewFixedOrFreshSuspension:
    ...
    def type_(self, value: SpecimenType) -> None: ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, readable_id:builtins.str, name:builtins.str, submitted_by:uuid.UUID, lab_id:uuid.UUID, received_at:datetime.datetime, species:typing.Sequence[Species], fixative:typing.Optional[SuspensionFixative]=None, measurements:typing.Sequence[NewSpecimenMeasurement]=[], committee_approvals:typing.Sequence[NewCommitteeApproval]=[], notes:typing.Optional[builtins.str]=None, returned_at:typing.Optional[datetime.datetime]=None, returned_by:typing.Optional[uuid.UUID]=None) -> NewFixedOrFreshSuspension: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class NewFrozenSuspension:
    ...
    def type_(self, value: SpecimenType) -> None: ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, readable_id:builtins.str, name:builtins.str, submitted_by:uuid.UUID, lab_id:uuid.UUID, received_at:datetime.datetime, species:typing.Sequence[Species], measurements:typing.Sequence[NewSpecimenMeasurement]=[], committee_approvals:typing.Sequence[NewCommitteeApproval]=[], notes:typing.Optional[builtins.str]=None, returned_at:typing.Optional[datetime.datetime]=None, returned_by:typing.Optional[uuid.UUID]=None) -> NewFrozenSuspension: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class NewOcmChromiumRun:
    ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, readable_id:builtins.str, assay_id:uuid.UUID, run_at:datetime.datetime, succeeded:builtins.bool, run_by:uuid.UUID, gems:typing.Sequence[NewOcmGems], notes:typing.Optional[builtins.str]=None) -> NewOcmChromiumRun: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class NewPoolMultiplexChromiumRun:
    ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, readable_id:builtins.str, assay_id:uuid.UUID, run_at:datetime.datetime, run_by:uuid.UUID, succeeded:builtins.bool, gems:typing.Sequence[NewPoolMultiplexGems], notes:typing.Optional[builtins.str]=None) -> NewPoolMultiplexChromiumRun: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class NewPoolMultiplexGems:
    ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, readable_id:builtins.str, suspension_pool_id:uuid.UUID, suspension_volume_loaded:SuspensionMeasurementFields, buffer_volume_loaded:SuspensionMeasurementFields, notes:typing.Optional[builtins.str]=None) -> NewPoolMultiplexGems: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class NewSingleplexChromiumRun:
    ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, readable_id:builtins.str, assay_id:uuid.UUID, run_at:datetime.datetime, run_by:uuid.UUID, succeeded:builtins.bool, gems:typing.Sequence[NewSingleplexGems], notes:typing.Optional[builtins.str]=None) -> NewSingleplexChromiumRun: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class NewSingleplexGems:
    ...
    def loading(self, value: builtins.list[NewSingleplexChipLoading]) -> None: ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, readable_id:builtins.str, suspension_id:uuid.UUID, suspension_volume_loaded:SuspensionMeasurementFields, buffer_volume_loaded:SuspensionMeasurementFields, notes:typing.Optional[builtins.str]=None) -> NewSingleplexGems: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
