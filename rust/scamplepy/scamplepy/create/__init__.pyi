...
class NewCryopreservedSuspension:
    ...
    def type_(self, value: SpecimenType) -> None: ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, readable_id:builtins.str, name:builtins.str, submitted_by:uuid.UUID, lab_id:uuid.UUID, received_at:datetime.datetime, species:typing.Sequence[Species], measurements:typing.Sequence[NewSpecimenMeasurement]=[], committee_approvals:typing.Sequence[NewCommitteeApproval]=[], returned_at:typing.Optional[datetime.datetime]=None, returned_by:typing.Optional[uuid.UUID]=None, additional_data:typing.Optional[typing]=None) -> NewCryopreservedSuspension: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class NewCryopreservedTissue:
    ...
    def type_(self, value: SpecimenType) -> None: ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, readable_id:builtins.str, name:builtins.str, submitted_by:uuid.UUID, lab_id:uuid.UUID, received_at:datetime.datetime, species:typing.Sequence[Species], measurements:typing.Sequence[NewSpecimenMeasurement]=[], committee_approvals:typing.Sequence[NewCommitteeApproval]=[], returned_at:typing.Optional[datetime.datetime]=None, returned_by:typing.Optional[uuid.UUID]=None, additional_data:typing.Optional[typing]=None) -> NewCryopreservedTissue: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class NewFixedBlock:
    ...
    def type_(self, value: SpecimenType) -> None: ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, readable_id:builtins.str, name:builtins.str, submitted_by:uuid.UUID, lab_id:uuid.UUID, received_at:datetime.datetime, species:typing.Sequence[Species], embedded_in:FixedBlockEmbeddingMatrix, fixative:BlockFixative, measurements:typing.Sequence[NewSpecimenMeasurement]=[], committee_approvals:typing.Sequence[NewCommitteeApproval]=[], returned_at:typing.Optional[datetime.datetime]=None, returned_by:typing.Optional[uuid.UUID]=None, additional_data:typing.Optional[typing]=None) -> NewFixedBlock: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class NewFixedTissue:
    ...
    def type_(self, value: SpecimenType) -> None: ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, readable_id:builtins.str, name:builtins.str, submitted_by:uuid.UUID, lab_id:uuid.UUID, received_at:datetime.datetime, species:typing.Sequence[Species], fixative:TissueFixative, measurements:typing.Sequence[NewSpecimenMeasurement]=[], committee_approvals:typing.Sequence[NewCommitteeApproval]=[], returned_at:typing.Optional[datetime.datetime]=None, returned_by:typing.Optional[uuid.UUID]=None, additional_data:typing.Optional[typing]=None) -> NewFixedTissue: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class NewFrozenSuspension:
    ...
    def type_(self, value: SpecimenType) -> None: ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, readable_id:builtins.str, name:builtins.str, submitted_by:uuid.UUID, lab_id:uuid.UUID, received_at:datetime.datetime, species:typing.Sequence[Species], measurements:typing.Sequence[NewSpecimenMeasurement]=[], committee_approvals:typing.Sequence[NewCommitteeApproval]=[], returned_at:typing.Optional[datetime.datetime]=None, returned_by:typing.Optional[uuid.UUID]=None, additional_data:typing.Optional[typing]=None) -> NewFrozenSuspension: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class NewFrozenTissue:
    ...
    def type_(self, value: SpecimenType) -> None: ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, readable_id:builtins.str, name:builtins.str, submitted_by:uuid.UUID, lab_id:uuid.UUID, received_at:datetime.datetime, species:typing.Sequence[Species], measurements:typing.Sequence[NewSpecimenMeasurement]=[], committee_approvals:typing.Sequence[NewCommitteeApproval]=[], returned_at:typing.Optional[datetime.datetime]=None, returned_by:typing.Optional[uuid.UUID]=None, additional_data:typing.Optional[typing]=None) -> NewFrozenTissue: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
