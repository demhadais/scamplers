...
class NewOcmGems:
    ...
    def chemistry(self) -> builtins.str: ...
    @property
    def loading(self) -> builtins.list[_NewSingleplexChipLoading]: ...
    @inner.setter
    def inner(self, value: _NewGemsCommon) -> None: ...
    @chemistry.setter
    def chemistry(self, value: builtins.str) -> None: ...
    @loading.setter
    def loading(self, value: builtins.list[_NewSingleplexChipLoading]) -> None: ...
    def __new__(cls, *, readable_id:builtins.str, chemistry:builtins.str, loading:typing.Sequence[_NewSingleplexChipLoading]) -> NewOcmGems: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class _NewSingleplexChipLoading:
    @property
    def suspension_id(self) -> uuid.UUID: ...
    @property
    def inner(self) -> _NewChipLoadingCommon: ...
    ...
    @inner.setter
    def inner(self, value: _NewChipLoadingCommon) -> None: ...
    def __new__(cls, *, suspension_id:uuid.UUID, suspension_volume_loaded:SuspensionMeasurementFields, buffer_volume_loaded:SuspensionMeasurementFields, notes:typing.Optional[builtins.str]=None) -> _NewSingleplexChipLoading: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
    def from_json_bytes(json_bytes:typing.Sequence[builtins.int]) -> _NewSingleplexChipLoading: ...
    @staticmethod
    def from_json_string(json_str:builtins.str) -> _NewSingleplexChipLoading: ...
    @staticmethod
    def from_base64_json(base64_json_bytes:builtins.str) -> _NewSingleplexChipLoading: ...
