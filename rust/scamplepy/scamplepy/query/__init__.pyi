...
class ChromiumRunQuery:
    ...
    def pagination(self, value: Pagination) -> None: ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, ids:typing.Sequence[uuid.UUID]=[], readable_ids:typing.Sequence[builtins.str]=[], assay:typing.Optional[TenxAssayQuery]=None, run_before:typing.Optional[datetime.datetime]=None, run_after:typing.Optional[datetime.datetime]=None, succeeded:typing.Optional[builtins.bool]=None, notes:typing.Sequence[builtins.str]=[], order_by:builtins.list[OrderBy]=..., limit:builtins.int=500, offset:builtins.int=0) -> ChromiumRunQuery: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class SpecimenQuery:
    ...
    def pagination(self, value: Pagination) -> None: ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, ids:typing.Sequence[uuid.UUID]=[], names:typing.Sequence[builtins.str]=[], submitters:typing.Sequence[uuid.UUID]=[], labs:typing.Sequence[uuid.UUID]=[], received_before:typing.Optional[datetime.datetime]=None, received_after:typing.Optional[datetime.datetime]=None, species:typing.Sequence[Species]=[], notes:typing.Sequence[builtins.str]=[], types:typing.Sequence[SpecimenType]=[], embedded_in:typing.Sequence[FixedBlockEmbeddingMatrix | FrozenBlockEmbeddingMatrix]=[], fixatives:typing.Sequence[BlockFixative | SuspensionFixative | TissueFixative]=[], storage_buffers:typing.Sequence[builtins.str]=[], frozen:typing.Optional[builtins.bool]=None, cryopreserved:typing.Optional[builtins.bool]=None, order_by:builtins.list[OrderBy]=..., limit:builtins.int=500, offset:builtins.int=0) -> SpecimenQuery: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
