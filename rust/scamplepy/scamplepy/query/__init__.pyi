...
class ChromiumRunQuery:
    ...
    @property
    def additional_data(self) -> builtins.list[typing]: ...
    @property
    def order_by(self) -> builtins.list[OrderBy]: ...
    @property
    def pagination(self) -> Pagination: ...
    ...
    def additional_data(self, value: builtins.list[typing]) -> None: ...
    @order_by.setter
    def order_by(self, value: builtins.list[OrderBy]) -> None: ...
    @pagination.setter
    def pagination(self, value: Pagination) -> None: ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, ids:typing.Sequence[uuid.UUID]=[], readable_ids:typing.Sequence[builtins.str]=[], assay:typing.Optional[TenxAssayQuery]=None, run_before:typing.Optional[datetime.datetime]=None, run_after:typing.Optional[datetime.datetime]=None, succeeded:typing.Optional[builtins.bool]=None, additional_data:typing.Sequence[typing]=[], order_by:builtins.list[OrderBy]=..., limit:builtins.int=500, offset:builtins.int=0) -> ChromiumRunQuery: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
...
class SpecimenQuery:
    ...
    @property
    def tissues(self) -> builtins.list[builtins.str]: ...
    @property
    def additional_data(self) -> builtins.list[typing]: ...
    @property
    def order_by(self) -> builtins.list[OrderBy]: ...
    ...
    @tissues.setter
    def tissues(self, value: builtins.list[builtins.str]) -> None: ...
    @additional_data.setter
    def additional_data(self, value: builtins.list[typing]) -> None: ...
    @order_by.setter
    def order_by(self, value: builtins.list[OrderBy]) -> None: ...
    ...
    def pagination(self, value: Pagination) -> None: ...
    def __eq__(self, other:builtins.object) -> builtins.bool: ...
    def __new__(cls, *, ids:typing.Sequence[uuid.UUID]=[], names:typing.Sequence[builtins.str]=[], submitters:typing.Sequence[uuid.UUID]=[], labs:typing.Sequence[uuid.UUID]=[], received_before:typing.Optional[datetime.datetime]=None, received_after:typing.Optional[datetime.datetime]=None, species:typing.Sequence[Species]=[], types:typing.Sequence[SpecimenType]=[], embedded_in:typing.Sequence[FixedBlockEmbeddingMatrix | FrozenBlockEmbeddingMatrix]=[], fixatives:typing.Sequence[BlockFixative | SuspensionFixative | TissueFixative]=[], frozen:typing.Optional[builtins.bool]=None, cryopreserved:typing.Optional[builtins.bool]=None, tissues:typing.Sequence[builtins.str]=[], additional_data:typing.Sequence[typing]=[], order_by:builtins.list[OrderBy]=..., limit:builtins.int=500, offset:builtins.int=0) -> SpecimenQuery: ...
    def to_json_bytes(self) -> builtins.list[builtins.int]: ...
    def to_json_string(self) -> builtins.str: ...
    def to_base64_json(self) -> builtins.str: ...
    @staticmethod
