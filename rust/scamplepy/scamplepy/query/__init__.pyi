...
class ChromiumRunQuery:
    ...
    @property
    def chips(self) -> builtins.list[builtins.str]: ...
    @property
    ...
    @chips.setter
    def chips(self, value: builtins.list[builtins.str]) -> None: ...
    @run_before.setter
...
class SpecimenQuery:
    ...
    def embedded_in(
        self,
    ) -> builtins.list[FixedBlockEmbeddingMatrix | FrozenBlockEmbeddingMatrix]: ...
    @property
    def fixatives(
        self,
    ) -> builtins.list[BlockFixative | SuspensionFixative | TissueFixative]: ...
    @property
    ...
    def embedded_in(
        self,
        value: builtins.list[FixedBlockEmbeddingMatrix | FrozenBlockEmbeddingMatrix],
    ) -> None: ...
    @fixatives.setter
    def fixatives(
        self, value: builtins.list[BlockFixative | SuspensionFixative | TissueFixative]
    ) -> None: ...
    ...
    def __new__(
        ...
        *,
        ...
        submitters: typing.Sequence[uuid.UUID] = [],
        labs: typing.Sequence[uuid.UUID] = [],
        received_before: typing.Optional[datetime.datetime] = None,
        received_after: typing.Optional[datetime.datetime] = None,
        species: typing.Sequence[Species] = [],
        notes: typing.Sequence[builtins.str] = [],
        types: typing.Sequence[SpecimenType] = [],
        embedded_in: typing.Sequence[
            FixedBlockEmbeddingMatrix | FrozenBlockEmbeddingMatrix
        ] = [],
        fixatives: typing.Sequence[
            BlockFixative | SuspensionFixative | TissueFixative
        ] = [],
        storage_buffers: typing.Sequence[builtins.str] = [],
        frozen: typing.Optional[builtins.bool] = None,
        cryopreserved: typing.Optional[builtins.bool] = None,
        order_by: builtins.list[OrderBy] = ...,
