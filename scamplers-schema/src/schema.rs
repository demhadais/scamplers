...
diesel::table! {
    library_type_specification (assay_id, library_type) {
        assay_id -> Uuid,
        library_type -> Text,
        index_kit -> Text,
...
diesel::joinable!(chromium_dataset_web_summaries -> chromium_dataset (dataset_id));
...
diesel::joinable!(library_type_specification -> tenx_assay (assay_id));
