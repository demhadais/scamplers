...
impl From<ScamplersError> for ScamplersErrorResponse {
    fn from(mut err: ScamplersError) -> Self {
        use ScamplersError::{
            CdnaGems, CdnaLibraryType, Client, DatasetCmdline, DatasetMetricsFileParse,
            DatasetNMetricsFiles, DuplicateResource, InvalidData, InvalidMeasurement,
            InvalidReference, LibraryIndexSet, MalformedRequest, PermissionDenied,
            ResourceNotFound, Server,
        };
