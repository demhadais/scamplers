...
export const sequencingrunsummary_id: (a: number) => [number, number];
...
export const chromiumrun_id: (a: number) => [number, number];
...
export const chromiumrunsummary_id: (a: number) => [number, number];
...
export const __wbg_datasetcore_free: (a: number, b: number) => void;
export const __wbg_get_datasetcore_summary: (a: number) => number;
export const __wbg_set_datasetcore_summary: (a: number, b: number) => void;
export const __wbg_get_datasetcore_lab: (a: number) => number;
export const __wbg_set_datasetcore_lab: (a: number, b: number) => void;
